    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='hive_connector.ConnectorFormPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
