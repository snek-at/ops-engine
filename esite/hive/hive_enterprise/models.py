...
class ContributionFeed(ClusterableModel):
    ...
    graphql_fields = [
        GraphQLForeignKey("page", content_type="hive_enterprise.Contributor"),
        GraphQLString("type"),
        GraphQLString("cid"),
        GraphQLString("datetime"),
        GraphQLString("message"),
        GraphQLCollection(
            GraphQLForeignKey, "files", "hive_enterprise.ContributionFile"
        ),
        GraphQLCollection(
            GraphQLForeignKey, "codelanguages", "hive_enterprise.CodeLanguageStatistic"
        ),
    ]
...
class Contributor(ClusterableModel):
    ...
    graphql_fields = [
        GraphQLForeignKey("page", content_type="hive_enterprise.EnterpriseFormPage"),
        GraphQLString("name"),
        GraphQLString("username"),
        GraphQLBoolean("active"),
        GraphQLImage("avatar"),
        GraphQLCollection(
            GraphQLForeignKey, "contribution_feed", "hive_enterprise.ContributionFeed"
        ),
        GraphQLCollection(
            GraphQLForeignKey, "codelanguages", "hive_enterprise.CodeLanguageStatistic"
        ),
        GraphQLCollection(
            GraphQLForeignKey,
            "codetransition",
            "hive_enterprise.CodeTransitionStatistic",
        ),
    ]
...
class ProjectContributor(ClusterableModel):
    ...
    graphql_fields = [
        GraphQLForeignKey("project", content_type="hive_enterprise.ProjectContributor"),
        GraphQLString("name"),
        GraphQLString("username"),
        GraphQLBoolean("active"),
        GraphQLImage("avatar"),
...
class Project(ClusterableModel):
    ...
    graphql_fields = [
        GraphQLForeignKey("page", content_type="hive_enterprise.Project"),
        GraphQLString("name"),
        GraphQLString("url"),
        ...
        GraphQLCollection(
            GraphQLForeignKey, "contributors", "hive_enterprise.ProjectContributor"
        ),
        GraphQLCollection(
            GraphQLForeignKey, "codelanguages", "hive_enterprise.CodeLanguageStatistic"
        ),
...
class EnterpriseFormPage(BaseEmailFormPage):
    ...
    graphql_fields += [
        GraphQLCollection(
            ...
            "hive_enterprise.ContributionFeed",
        ),
        GraphQLCollection(
            GraphQLForeignKey, "connector_scp_page", "hive_connector.Connector",
        ),
    ]
    # Contributors
    ...
    graphql_fields += [
        GraphQLCollection(
            GraphQLForeignKey, "enterprise_contributors", "hive_enterprise.Contributor"
        )
    ]
    # Projects
    ...
    graphql_fields += [
        GraphQLCollection(
            GraphQLForeignKey, "enterprise_projects", "hive_enterprise.Project"
        ),
    ]
    # CodeLanguageStatistic
    ...
    graphql_fields += [
        GraphQLCollection(
            ...
            "hive_enterprise.CodeLanguageStatistic",
        ),
    ]
    # CodeTransitionStatistic
    ...
    def full_clean(self, *args, **kwargs):
        ...
        super(EnterpriseFormPage, self).full_clean(*args, **kwargs)
